...
The agent itself is built on [koog-agents](https://github.com/JetBrains/koog) and talks to OpenAI (default) or a local Ollama instance as the LLM backend. Telegram I/O uses [tgbotapi](https://github.com/InsanusMokrassar/ktgbotapi).
