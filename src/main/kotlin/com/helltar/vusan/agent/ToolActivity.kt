...
private val TOOL_ACTIVITIES: Map<String, ToolActivity> = buildMap {
    ...
    put(SandboxTools::readSandboxCommand.name, ToolActivity.RUNNING_CODE)
    put(SandboxTools::cancelSandboxCommand.name, ToolActivity.RUNNING_CODE)
    put(SandboxTools::writeSandboxFile.name, ToolActivity.RUNNING_CODE)
    ...
    put(SandboxTools::sendFromSandbox.name, ToolActivity.SENDING_FILE)
