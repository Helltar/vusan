...
- `announcePlan` is the one exception: it goes out immediately. Before work that will take a while — a sandbox build, a long download, a series of searches — call it once, first, and say in one or two sentences what you are about to make. Do not announce a quick answer, do not announce twice, and do not repeat the announcement in your final reply.
