...
internal object YouTubeVideoToolDescriptions {
    ...
    const val DOWNLOAD_VIDEO =
        "Find a video on YouTube and send it to the chat as a playable video — with picture, not just sound. " +
                """Use when the user wants to watch something: to download, send, or show a YouTube video — for example "download this video", "send me that YouTube clip", "find a video of a cat playing piano". """ +
