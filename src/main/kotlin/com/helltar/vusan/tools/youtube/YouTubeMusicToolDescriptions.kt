...
internal object YouTubeMusicToolDescriptions {
    ...
    const val PLAY_FULL_TRACK =
        "Find a song on YouTube and send it to the chat as an audio file — audio only, no picture. " +
                """Use when the user wants to listen to music: to play, download, or send a track — for example "play Imagine Dragons Believer", "play the full song", "send me the audio of ...". """ +
