...
internal object YouTubeTranscriptToolDescriptions {
    ...
    const val READ_TRANSCRIPT =
        "Read what is actually said in a YouTube video by fetching its subtitle track, without downloading the video. " +
                """Use whenever the user asks about the content of a video: to summarize it, to pull out the key points or timestamps-free facts, or to answer a question about it — for example "what is this video about", "summarize this talk", "did he say anything about prices".""" +
