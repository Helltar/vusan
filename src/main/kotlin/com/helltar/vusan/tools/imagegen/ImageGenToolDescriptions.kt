...
internal object ImageGenToolDescriptions {
    ...
    const val GENERATE_IMAGE =
        "Generate a brand-new image from a text description and send it to the chat as a photo. " +
                ...
                "This creates original AI art — it does NOT search the web: use `searchImages` when the user wants a real photo of a real thing, and `runCommand` for charts or plots from data. " +
